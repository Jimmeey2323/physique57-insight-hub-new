...
export const StrengthDetailedTable: React.FC<StrengthDetailedTableProps> = ({
  data,
  onItemClick
}) => {
  return (
            ...
            <tbody>
              {data.map((trainer, index) => {
                ...
                return (
                  <tr 
                    key={trainer.unique}
                    className="border-b border-green-100 hover:bg-green-50 cursor-pointer"
                    onClick={() => onItemClick({ 
                  ...
                  >
                    <td className="p-3">
                      <div>
                        <div className="font-medium text-green-900">{trainer.teacherName}</div>
