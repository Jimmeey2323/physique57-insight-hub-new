...
>(({ className, ...props }, ref) => (
  <div className="table-modern relative w-full overflow-auto">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-gradient-to-r from-slate-700 to-slate-800 [&_tr]:border-none [&_th]:text-white [&_th]:font-bold", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-[35px] max-h-[35px] px-4 py-2 text-left align-middle text-white font-bold [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
